...
import com.jonmid.segundoparcial.Parser.TeamJsonOlivaCeballos;
...
public class TeamActivity extends AppCompatActivity {
    ...
    RecyclerView recyclerView;
            List<TeamModelOlivaCristian> olivaCristianList;
    ...
    public void loadData() {
        if (isOnLine()) {
            ...
            taskUser.execute("http://api.football-data.org/v1/competitions/445/teams");
        } else {
    ...
    public void processData() {
        teamAdapterOlivaCristian = new TeamAdapterOlivaCristian(olivaCristianList, getApplicationContext());
        recyclerView.setAdapter(teamAdapterOlivaCristian);
    ...
    public  class TaskUser extends AsyncTask<String,String,String> {
        ...
        protected void onPostExecute(String s) {
            ...
            try {
                olivaCristianList = TeamJsonOlivaCeballos.getData(s);
